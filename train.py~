...
def main(args):
    ...
    data_loader = IC15Loader(is_transform=True, img_size=args.img_size, kernel_num=kernel_num, min_scale=min_scale,train_data_path=args.train_data_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path',nargs='?', type=str, default='',    
                        help='Path to train dataset,which cotains two folders: image  label')
