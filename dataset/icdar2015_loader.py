...
class IC15Loader(data.Dataset):
    def __init__(self, is_transform=False, img_size=None, kernel_num=7, min_scale=0.4, train_data_path=''):
    
        train_data_dir = train_data_path + 'image/'
        train_gt_dir = train_data_path + 'label/'
