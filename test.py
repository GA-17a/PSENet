...
def test(args):
    data_loader = IC15TestLoader(test_data_path = args.test_data_path, long_size=args.long_size)
    ...
    for idx, (org_img, img) in enumerate(test_loader):
        ...
        write_result_as_txt(image_name, bboxes,  args.save_image_path)
        
        text_box = cv2.resize(text_box, (text.shape[1], text.shape[0]))
        debug(idx, data_loader.img_paths, [[text_box]], args.save_image_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_score', nargs='?', type=float, default=0.93,
                        help='min score')
    parser.add_argument('--test_data_path',nargs='?', type=str, default='',    
                        help='Path to test dataset')
    parser.add_argument('--save_image_path',nargs='?', type=str, default='',    
                        help='Path to save the output image')
    parser.add_argument('--gpu_list',nargs='?', type=str, default='0',    
                        help='gpu list')   
